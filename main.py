...
def level_One(action):
    while action == 'lev1':
        ...
        levelOne.check(p, ch1_levelOne,levelOne.pHitbox,levelOne.plats, levelOne.slugs, levelOne.borders, levelOne.bird_p, levelOne.bird_hitboxes, levelOne.doorRect)
